...
class TableComposer(simplyPdfDocument: SimplyPdfDocument) : GroupComposer(simplyPdfDocument) {
    ...
    fun draw(cellList: List<List<Cell>>, properties: TableProperties) {
        ...
        cellList.forEach { rowCellList ->
            ...
            if (properties.drawBorder) {
                drawBorders(
                    pageCanvas, largestHeight.toFloat(), alignTranslate,
    ...
    private fun drawBorders(
        ...
        canvas.save()
        canvas.translate(
            simplyPdfDocument.startMargin.toFloat() + xTranslate,
        ...
        rowCellList.forEach { cell ->
            //Left border
            if (colIndex == 0 && canDrawLeftBorder(
                    tableProperties,
                    rowIndex,
                    rowCount,
                    colIndex,
    ...
    private fun canDrawRightBorder(
        prop: TableProperties,
        rowIndex: Int,
        rowCount: Int,
        colIndex: Int,
    ...
    private fun canDrawBottomBorder(
        prop: TableProperties,
        rowIndex: Int,
        rowCount: Int,
        colIndex: Int,
